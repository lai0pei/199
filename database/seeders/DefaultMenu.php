...
class DefaultMenu extends Seeder
{
    ...
    public function run()
    {
        $config = [
            ...
            4 => ['id' => 5, 'p_id' => 4, 'title' => '创建活动', 'auth_name' => 'add_event', 'icon' => 'fa fa-plus-circle', 'href' => 'admin/add_event', 'sort' => 0, 'created_at' => now(), 'updated_at' => now()],
            5 => ['id' => 6, 'p_id' => 4, 'title' => '活动列表', 'auth_name' => 'event_lists', 'icon' => 'fa fa-list', 'href' => 'admin/event_lists', 'sort' => 1, 'created_at' => now(), 'updated_at' => now()],

            6 => ['id' => 7, 'p_id' => 2, 'title' => 'VIP用户管理', 'auth_name' => 'vip_users', 'icon' => 'fa fa-user-secret', 'href' => '', 'sort' => 1, 'created_at' => now(), 'updated_at' => now()],
            7 => ['id' => 8, 'p_id' => 7, 'title' => '手机号管理', 'auth_name' => 'mobile_management', 'icon' => 'fa fa-mobile', 'href' => 'admin/mobile_management', 'sort' => 0, 'created_at' => now(), 'updated_at' => now()],
            8 => ['id' => 9, 'p_id' => 7, 'title' => '用户申请记录', 'auth_name' => 'user_apply', 'icon' => 'fa fa-reply-all', 'href' => 'admin/user_apply', 'sort' => 1, 'created_at' => now(), 'updated_at' => now()],
            9 => ['id' => 10, 'p_id' => 7, 'title' => '用户短信申请', 'auth_name' => 'sms_apply', 'icon' => 'fa fa-comments-o', 'href' => 'admin/sms_apply', 'sort' => 2, 'created_at' => now(), 'updated_at' => now()],

            10 => ['id' => 11, 'p_id' => 2, 'title' => '基本配置', 'auth_name' => 'basic_settings', 'icon' => 'fa fa-cog', 'href' => '', 'sort' => 2, 'created_at' => now(), 'updated_at' => now()],
            11 => ['id' => 12, 'p_id' => 11, 'title' => '批量拒绝回复', 'auth_name' => 'bulk_refuse', 'icon' => 'fa fa-exclamation-triangle', 'href' => 'admin/bulk_refuse', 'sort' => 0, 'created_at' => now(), 'updated_at' => now()],
            12 => ['id' => 13, 'p_id' => 11, 'title' => '批量通过回复', 'auth_name' => 'bulk_pass', 'icon' => 'fa fa-check', 'href' => 'admin/bulk_pass', 'sort' => 1, 'created_at' => now(), 'updated_at' => now()],
            13 => ['id' => 14, 'p_id' => 11, 'title' => '链接管理', 'auth_name' => 'link_management', 'icon' => 'fa fa-link', 'href' => 'admin/link_management', 'sort' => 2, 'created_at' => now(), 'updated_at' => now()],
            14 => ['id' => 15, 'p_id' => 11, 'title' => '游戏管理', 'auth_name' => 'game_management', 'icon' => 'fa fa-gamepad', 'href' => 'admin/game_management', 'sort' => 3, 'created_at' => now(), 'updated_at' => now()],
            15 => ['id' => 16, 'p_id' => 11, 'title' => '公告通知', 'auth_name' => 'announcement', 'icon' => 'fa fa-bullhorn', 'href' => 'admin/announcement', 'sort' => 3, 'created_at' => now(), 'updated_at' => now()],

            16 => ['id' => 17, 'p_id' => 3, 'title' => '人员管理', 'auth_name' => 'admin_management', 'icon' => 'fa fa-user', 'href' => '', 'sort' => 3, 'created_at' => now(), 'updated_at' => now()],
            17 => ['id' => 18, 'p_id' => 17, 'title' => '管理员', 'auth_name' => 'person', 'icon' => 'fa fa-user-plus', 'href' => 'admin/person', 'sort' => 0, 'created_at' => now(), 'updated_at' => now()],
