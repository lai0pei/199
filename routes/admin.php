...
Route::post($prefix.'/login', [LoginController::class, 'login'])->name('admin.login.login');
Route::post('/ueditor', [UploadController::class, 'ueditorUpload']);
Route::get($prefix.'/login', [LoginController::class, 'index'])->name('admin.login.index');
Route::get($prefix.'/captcha', [LoginController::class, 'captcha'])->name('admin.login.captcha');
...
| 后台路由
 */
Route::middleware(['admin'])->prefix($prefix)->group(function () {
    //后台页面
