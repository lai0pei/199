                    ...
                    <form class="layui-form layui-form-pane" lay-filter="data-search-filter" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="start" id="created_at" readonly placeholder="选择日期" autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div>
                            <div class="layui-inline">
                            ...
                            <div class="layui-inline">
                                <label class="layui-form-label">用户IP地址</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="ip" autocomplete="off" class="layui-input" placeholder="列如 : 127.0.0.1">
                                </div>
                            </div>
        ...
        layui.use(['form', 'table','laydate'], function () {
            ...
            table.render({
                ...
                cols: [[
                    ...
                    {field:'title',title: '日志内容',sort:true},
                    {field:'admin_name',title: '操作管理人',sort:true},
