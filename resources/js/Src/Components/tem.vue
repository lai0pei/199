                ...
                <ul>
                  <li>
                    <div>
                      ...
                      <input
                        placeholder="会员账号"
                        class="allForms rounded-md" v-model="username" 
                      />
                    </div>
                  </li>
                  <li v-for="(form, index) in formList" :key="index">
                    <div v-if="form.type == 0">
                      <input
                        ...
                        alt="输入"
                        class="allForms mt-1 rounded-md" v-model="formName.inputForm[form.id]"
                      />
                    </div>
                    <div v-if="form.type == 1">
                      <input
                        ...
                        v-bind:placeholder="form.name"
                        alt="数字"
                        class="allForms mt-1 rounded-md"  v-model="formName.numberForm[form.id]"
                      />
                    </div>
                    <div v-if="form.type == 2">
                      <input
                        ...
                        v-bind:placeholder="form.name"
                        alt="手机"
                        class="allForms mt-1 rounded-md" v-model="formName.phoneForm[form.id]"
                      />
                    ...
                    <div v-if="form.type == 3">
                      <input
                        ...
                        v-bind:placeholder="form.name"
                        alt="时间"
                        class="allForms mt-1 rounded-md"  v-model="formName.timeForm[form.id]"
                      />
                   
                    </div>
                    <div v-if="form.type == 4">
                     <input type="file" accept="image/*"  class="allForms mt-1 rounded-md"  v-bind:placeholder="form.name"
                        alt="图片" >
                    </div>
                    <div v-if="form.type == 5">
                      <select id="sel" class="allForms mt-1 rounded-md" v-model="formName.selectForm[form.id]">
                        <option selected :value="form.name">{{form.name}}</option>
                        <option
                  ...
                  <span class="float-left"><button v-on:click="showModal = false"  class="btnSubmit bg-eventBtn block m-auto">取消</button></span>
              <span class="float-right"><button v-on:click="submit"  class="btnSubmit bg-eventBtn block m-auto">点击申请</button></span>
            </div>
              </slot>
            </div>
